...
router.put("/:id/attend-meeting", user_1.default, auth_1.default, post_controller_1.addUserToMeeting);
router.put("/:id/remove-from-meeting", user_1.default, auth_1.default, post_controller_1.removeUserFromMeeting);
