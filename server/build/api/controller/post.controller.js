...
exports.likePostComment =
  exports.addUserToMeeting =
  exports.removeUserFromMeeting =
  exports.likePost =
  exports.deleteComment =
  exports.updateCommentOnPost =
  exports.commentOnPost =
  exports.getPostBySlug =
  exports.getPostById =
  exports.getAllPosts =
  exports.deletePost =
  exports.updatePost =
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            Post_1.default.find(__assign({}, other)).limit(parseInt(limit)),
          ];
        case 2:
          posts = _b.sent();
...
var getPostBySlug = function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    var id, post, err_6;
    return __generator(this, function (_a) {
      switch (_a.label) {
...
var updateCommentOnPost = function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
        ...
        case 3:
          ...
          return [
            ...
            res
              .status(404)
              .json({
                error: "Something went wrong trying to update the comment",
              }),
          ];
        case 4:
          return [2 /*return*/];
...
var removeUserFromMeeting = function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 3:
          ...
          return [
            2 /*return*/,
            res.status(404).json({ error: err_11.message }),
          ];
        case 4:
          return [2 /*return*/];
      }
...
var addUserToMeeting = function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 3:
          ...
          return [
            2 /*return*/,
            res.status(404).json({ error: err_12.message }),
          ];
        case 4:
          return [2 /*return*/];
      }
...
var likePostComment = function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
